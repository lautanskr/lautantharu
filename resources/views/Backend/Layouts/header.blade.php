...
<head>
    ...
    <!-- Twitter -->
    <meta name="twitter:site" content="@lautan">
    <meta name="twitter:creator" content="@lautan">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Bracket">
    <meta name="twitter:description" content="Premium Quality and Responsive UI for Dashboard.">
    <meta name="twitter:image" content="img/bracket-social.html">

    <!-- Facebook -->
    <meta property="og:url" content="lautantharu.com">
    <meta property="og:title" content="Bracket">
    <meta property="og:description" content="Premium Quality and Responsive UI for Dashboard.">

    <meta property="og:image" content="img/bracket-social.html">
    <meta property="og:image:secure_url" content="img/bracket-social.html">
    ...
    <title>Lautan Tharu Portfolio-Admin</title>
  ...
  <body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="br-logo"><a href="#"><span>[</span>Lautan<span>]</span></a></div>
    <div class="br-sideleft overflow-y-auto">
      ...
      <div class="br-sideleft-menu">
        ...
        <a href="{{route('intro.index')}}" class="br-menu-link">
          <div class="br-menu-item">
        ...
        <nav class="nav">
          ...
          <div class="dropdown">
            <a href="#" class="nav-link nav-link-profile" data-toggle="dropdown">
              <span class="logged-name hidden-md-down">Lautan</span>
